{"inherits": "pesterchum2.5",
 "main":
 {"background-image": "$path/background.png",
  "size": [300,620],
  "icon": "$path/trayicon.png",
  "newmsgicon": "$path/trayicon2.png",
  "windowtitle": "Pester",
  "menu" : { "style": "font-family: 'Verdana'; font: bold; font-size: 14px; background-color: #6102C1;border:2px solid #6F20B6" },
  ...
  "defaultwindow": { "style": "background: #6102C1; font-family:'Verdana';font:bold;selection-background-color:black; " },
  "chums": { "style": "border:2px solid #6F20B6; background-color: #2b0057;color: #000000;font: bold;font-size:14px;font-family: 'Verdana';selection-background-color:black; ",
             "moods": { 
  ...
  "mychumhandle": { "label": 
					...
					"handle": { "style": "background-color: black; padding: 3px; padding-left: 25px; color:#6F20B6; font-family:'Verdana'; font:bold; text-align:left; border:2px solid #2b0057;" }
                  },
  "addchum":  { "style": "background: black; border:2px solid #6F20B6; font: bold; color: #2b0057; font-family:'Verdana';"
              },
  "pester": { "style": "background: black; border:2px solid #6F20B6; font: bold; color: #2b0057; font-family:'Verdana';"
            },
  "block": { "style": "background: black; border:2px solid #6F20B6; font: bold; color: #2b0057; font-family:'Verdana';"
           },
  "moodlabel": { "style": "font:bold;font-family:'Verdana';color:#FF0000;"
			   },
  "defaultmood": 18,
  "moods": [
      { "style": "text-align:left; background:#2b0057;border:2px solid black;color: black; font-family:'Verdana'; font:bold; padding-left:3px;", 
 ...
 "convo": {
     "style": "background-color: #2b0057;border:2px solid black; font-family: 'Verdana';",
     "chumlabel": { "style": "margin-bottom: 21px;background: #2b0057; color: black; border:0px; font-size: 14px;",
					"text" : ":: contacting: $handle ::" },
	 "textarea": {
		 "style": "background: #C289FE;  font-size: 14px;font:bold; border:2px solid #6F20B6;text-align:center; margin-right:10px; margin-left:10px;font-family: 'Verdana'"
 	 },
  "input": { "style": "background: #A64EFE; border:2px solid #2b0057;margin-top:5px; margin-right:10px; margin-left:10px; font-size: 12px;" },
	 "tabwindow" : {
		 "style": ""
	 },
	 "tabs": {
 ...
 { "size": [600,425],
   ...
   "textarea": {
	   "style": "background: #76D1D1;  font-size: 14px;font:bold; border:2px solid #6F20B6;text-align:center; margin-right:10px; margin-left:10px;font-family: 'Verdana'"
   },
   ...
   "input": { "style": "background: #48BCBC; border:2px solid #6F20B6;margin-top:5px; margin-right:10px; margin-left:10px; font-size: 12px;" },
   "time": { "text": { "style": " border: 2px solid #6F20B6; background: #48BCBC; font-size: 12px; margin-top: 5px; margin-right: 5px; margin-left: 5px; font-family:'Verdana';font:bold;" 
                    },
             "buttons": { "style": "color: black; font: bold; border: 2px solid #6F20B6; font: bold; font-size: 12px; background: #6F20B6; margin-top: 5px; margin-right: 5px; margin-left: 5px; padding: 2px; width: 50px;" }
          },

   "tabs": {
       "style": "",
       "selectedstyle": "#6F20B6",
       "newmsgcolor": "#A4AE1A",
       "tabstyle": 0
   },
   "scrollbar": null
