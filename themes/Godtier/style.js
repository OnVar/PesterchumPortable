{"main":
 {"style": "background-color:rgba(0,0,0,0); background-repeat: no-repeat;",
  "background-image": "$path/skaiaback.png",
  "size": [650, 650],
  ...
  "defaultwindow": { "style": "color: black; background: #39B7CD; font-family: 'Arial'; font: bold; selection-background-color: rgb(100,100,100);"
                   },
  "addchum":
  ...
  "moods": [
      { "style": "background-image:url($path/time1.png); border:0px;",
        "selected": "background-image:url($path/time2.png); border:0px;",
        "loc": [56, 433],
        "size": [50, 50],
        "text": "",
        "icon": "",
      ...
      { "style": "background-image:url($path/breath1.png); border:0px;",
        "selected": "background-image:url($path/breath2.png); border:0px;",
        "loc": [157, 534],
        "size": [50, 50],
        "text": "",
        "icon": "",
      ...
      { "style": "background-image:url($path/doom1.png); border:0px;",
        "selected": "background-image:url($path/doom2.png); border:0px;",
        "loc": [295, 574],
        "size": [50, 50],
        "text": "",
        "icon": "",
      ...
      { "style": "background-image:url($path/blood1.png); border:0px;",
        "selected": "background-image:url($path/blood2.png); border:0px;",
        "loc": [432, 534],
        "size": [50, 50],
        "text": "",
        "icon": "",
      ...
      { "style": "background-image:url($path/heart1.png); border:0px;",
        "selected": "background-image:url($path/heart2.png); border:0px;",
        "loc": [533, 433],
        "size": [50, 50],
        "text": "",
        "icon": "",
      ...
      { "style": "background-image:url($path/space1.png); border:0px;",
        "selected": "background-image:url($path/space2.png); border:0px;",
        "loc": [574, 295],
        "size": [50, 50],
        "text": "",
        "icon": "",
      ...
      { "style": "background-image:url($path/mind1.png); border:0px;",
        "selected": "background-image:url($path/mind2.png); border:0px;",
        "loc": [533, 157],
        "size": [50, 50],
        "text": "",
        "icon": "",
      ...
      { "style": "background-image:url($path/light1.png); border:0px;",
        "selected": "background-image:url($path/light2.png); border:0px;",
        "loc": [432, 56],
        "size": [50, 50],
        "text": "",
        "icon": "",
      ...
      { "style": "background-image:url($path/void1.png); border:0px;",
        "selected": "background-image:url($path/void2.png); border:0px;",
        "loc": [295, 16],
        "size": [50, 50],
        "text": "",
        "icon": "",
      ...
      { "style": "background-image:url($path/rage1.png); border:0px;",
        "selected": "background-image:url($path/rage2.png); border:0px;",
        "loc": [157, 56],
        "size": [50, 50],
        "text": "",
        "icon": "",
      ...
      { "style": "background-image:url($path/hope1.png); border:0px;",
        "selected": "background-image:url($path/hope2.png); border:0px;",
        "loc": [56, 157],
        "size": [50, 50],
        "text": "",
        "icon": "",
      ...
      { "style": "background-image:url($path/life1.png); border:0px;",
        "selected": "background-image:url($path/life2.png); border:0px;",
        "loc": [16, 295],
        "size": [50, 50],
        "text": "",
        "icon": "",
        ...
        "mood": 18
              ...
              { "style": "background-image:url($path/jake1.png); border:0px;",
        "selected": "background-image:url($path/jake2.png); border:0px;",
        "loc": [492, 101],
        "size": [50, 50],
        "text": "",
        "icon": "",
        "mood": 20
          ...
          { "style": "background-image:url($path/dirk1.png); border:0px;",
        "selected": "background-image:url($path/dirk2.png); border:0px;",
        "loc": [99, 101],
        "size": [50, 50],
        "text": "",
        "icon": "",
        "mood": 21
          ...
          { "style": "background-image:url($path/roxy1.png); border:0px;",
        "selected": "background-image:url($path/roxy2.png); border:0px;",
        "loc": [30, 225],
        "size": [50, 50],
        "text": "",
        "icon": "",
        "mood": 19
              ...
              { "style": "background-image:url($path/jane1.png); border:0px;",
        "selected": "background-image:url($path/jane2.png); border:0px;",
        "loc": [566, 225],
        "size": [50, 50],
        "text": "",
        "icon": "",
 ...
 "convo":
 {"style": "background: #39B7CD; font-family: 'Arial';",
  "scrollbar": { "style" : "", "handle": "" },
  "margins": {"top": 10, "bottom": 10, "left": 10, "right": 10 },
  "size": [400, 250],
  "size": [400, 250],
  "chumlabel": { "style": "background-image:url($path/chumlabelbg.png);background-color: #5DFC0A; background-repeat: no-repeat; color: black; padding: 2px; border:1px solid #c2c2c2; margin-bottom: 4px;",
  ...
  "textarea": {
      "style": "background: #E0EEEE; border:2px solid #c2c2c2; font-size: 14px;"
  },
  "input": {
      "style": "background: #E0EEEE;margin-top:5px; border:1px solid #c2c2c2; font-size: 12px;"
  },
  "tabwindow" : {
    "style": "background: #39B7CD; font-family: 'Arial'"
  },
  "tabs": {
      "style": "border: 2px solid black; background: #00688B; color: black;",
  ...
  "text": {
      ...
      "joinmemo": "ascended to memotier",
      "closememo": "has fallen from memotier",
 ...
 "style": "background: white; font-family: 'Arial';",
  "size": [450,300],
  "tabs": {
      "style": "border: 2px solid white; background: #8FD8D8; color: black;",
      "selectedstyle": "border: 3px solid white; background: white; color: black;",
      "newmsgcolor": "red",
      "tabstyle": 0
  },
  "label": { "text": "Bulletin Board: $channel",
             "style": "background-image:url($path/chumlabelbg.png);background-color:#5DFC0A; background-repeat: no-repeat; color: black; padding: 2px; border:1px solid #c2c2c2; margin-bottom: 4px;",
             "align": { "h": "left", "v": "center" },
             "minheight": 18,
             "maxheight": 18
           },
  "textarea": {
      "style": "background: #E0EEEE; border:2px solid #c2c2c2; font-size: 12px;"
  },
  "input": {
      "style": "background: #E0EEEE;margin-top:5px; border:1px solid  #c2c2c2; font-size: 12px; margin-bottom: 5px; "
  },
  "margins": {"top": 10, "bottom": 10, "left": 9, "right": 4 },
  "userlist": { "width": 125,
                "style": "font-size: 12px; background: #E0EEEE; margin-bottom: 5px; border:2px solid #c2c2c2; padding: 5px; font-family: 'Arial';selection-background-color:rgb(200,200,200);"
              },
  "time": { "text": { "width": 75,
            ...
            "buttons": { "style": "border:1px solid rgb(166,166,166); height: 17px; width: 50px; color: black; font-family: 'Arial'; background: #8FD8D8; margin-left: 2px;" },
