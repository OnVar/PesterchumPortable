{"main":
 {"style": "background-color:rgba(0,0,0,0); background-repeat: no-repeat;",
  ...
  "windowtitle": "GOLDTROLL",
  "close": { "image": "$path/x.png",
             "loc": [635, 2]},
  "minimize": { "image": "$path/m.png",
                "loc": [621, 8]},
  "menubar": { "style": "font-family: 'Arial'; font-size: 11px; color: rgba(0,0,0,0);" },
  "menu" : { "style": "font-family: 'Arial'; font-size: 11px; background-color: #DBD63F; border:1px solid #DBD942;",
             "selected": "background-color: #D6CC1B",
  ...
  "chums": { "style": "font-size: 12px; background: white; border:0px; font-family: 'Arial';selection-background-color:rgb(200,200,200); ",
             "scrollbar": { "style" : "background-color:#A8A314;",
                            "handle": "background-color:#8C8410;height:20px;border:2px solid #BFB82D;",
                            "downarrow": "",
                            "darrowstyle": "",
                            "uparrow": "",
                            "uarrowstyle": ""
  ...
  "defaultwindow": { "style": "background: #EDED78; font-family:'Arial';font:bold;selection-background-color:#545454; "
                   },
 ...
 "convo":
 {"style": "background:  rgb(123, 123, 14); font-family: 'Arial';",
  "scrollbar": { "style" : "", "handle": "" },
  "margins": {"top": 22, "bottom": 9, "left": 10, "right": 4 },
  "size": [400, 250],
  "size": [400, 250],
  "chumlabel": { "style": "background-image:url($path/chumlabelbg.png);background-color:rgb(208,208,10); background-repeat: no-repeat; color: white; padding: 2px; border:1px solid #FFFF00; margin-bottom: 4px;",
  ...
  "textarea": {
      "style": "background: white; border:2px solid #EFEF7F; font-size: 14px;"
  },
  "input": {
      "style": "background: white;margin-top:5px; border:1px solid #EDED82; margin-right: 54px; font-size: 12px; height: 19px;"
  },
  "tabwindow" : {
	  "style": "background: rgb(123, 123, 14); font-family: 'Arial'"
  },
 ...
 {"memoicon": "$path/memo.png",
  ...
  "label": { "text": "Bulletin Board: $channel",
             "style": "background-image:url($path/chumlabelbg.png);background-color:#C7C715(45,176,24); background-repeat: no-repeat; color: white; padding: 2px; border:1px solid#F6F691; margin-bottom: 4px;",
             "align": { "h": "left", "v": "center" },
             "minheight": 18,
             "maxheight": 36
           },
  "textarea": {
      "style": "background: white; border:2px solid #F6F69A; font-size: 12px;"
  },
  "input": {
      "style": "background: white;margin-top:5px; border:1px solid #EFEFA0; font-size: 12px; height: 19px; margin-bottom: 5px; "
  },
  "margins": {"top": 22, "bottom": 10, "left": 9, "right": 4 },
  "userlist": { "width": 125,
                "style": "font-size: 12px; background: white; margin-left: 5px; margin-bottom: 5px; border:2px solid #D0D07C; padding: 5px; font-family: 'Arial';selection-background-color:rgb(200,200,200);"
              },
  "time": { "text": { "width": 75, 
                      "style": "color: black; font:bold;  border:1px solid #D2D292; background: white; height: 19px;" 
                    },
            "slider": { "style": " border:1px solid #E1E197;",
                        "groove": "border-image:url($path/timeslider.png);",
                        "handle": "image:url($path/slidamajig.png);"
                      },
            "buttons": { "style": "border:1px solid #6D6D11; height: 17px; width: 50px; color: #B1B116; font-family: 'Arial'; background: rgb(241, 241, 120); margin-left: 2px;" }, 
