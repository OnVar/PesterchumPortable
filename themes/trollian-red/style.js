{"main":
 {"style": "background-color:rgba(0,0,0,0); background-repeat: no-repeat;",
  ...
  "chums": { "style": "font-size: 12px; background: white; border:0px; font-family: 'Arial';selection-background-color:rgb(200,200,200); ",
             "scrollbar": { "style" : "background-color:#c2c2c2;",
                            "handle": "background-color:#b41313;height:20px;border:2px solid #d53434;",
                            "downarrow": "",
                            "darrowstyle": "",
                            "uparrow": "",
                            "uarrowstyle": ""
  ...
  "trollslum": {
      "style": "background:  rgb(180, 19, 19); font-family: 'Arial'",
      "size": [175, 461],
 ...
 {"style": "background:  rgb(180, 19, 19); font-family: 'Arial';",
  ...
  "size": [400, 250],
  "size": [400, 250],
  "chumlabel": { "style": "background-image:url($path/chumlabelbg.png);background-color:rgb(213,52,52); background-repeat: no-repeat; color: white; padding: 2px; border:1px solid #c2c2c2; margin-bottom: 4px;",
 ...
 {"memoicon": "$path/memo.png",
  ...
  "label": { "text": "Bulletin Board: $channel",
             "style": "background-image:url($path/chumlabelbg.png);background-color:rgb(213,52,52); background-repeat: no-repeat; color: white; padding: 2px; border:1px solid #c2c2c2; margin-bottom: 4px;",
             "align": { "h": "left", "v": "center" },
             "minheight": 18,
             "maxheight": 36
           },
  ...
  "time": { "text": { "width": 75,
            ...
            "buttons": { "style": "border:1px solid #fa5959; height: 17px; width: 50px; color: #ff7d7d; font-family: 'Arial'; background: rgb(182, 21, 21); margin-left: 2px;" },
 ...
 "toasts":
 {
   "width": 210,
   "height": 100,
   "style": "background: rgb(213,52,52);",
   ...
   "content": { "style": "background: rgb(180, 19, 19); color: black; padding: 5px;" }
 }
}
