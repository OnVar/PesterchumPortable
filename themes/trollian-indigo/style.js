{"main":
 {"style": "background-color:rgba(0,0,0,0); background-repeat: no-repeat;",
  ...
  "chums": { "style": "font-size: 12px; background: white; border:0px; font-family: 'Arial';selection-background-color:rgb(200,200,200); ",
             "scrollbar": { "style" : "background-color:#c2c2c2;",
                            "handle": "background-color:#5f259a;height:20px;border:2px solid #8046bb;",
                            "downarrow": "",
                            "darrowstyle": "",
                            "uparrow": "",
                            "uarrowstyle": ""
  ...
  "trollslum": {
      "style": "background:  rgb(95, 37, 154); font-family: 'Arial'",
      "size": [175, 461],
 ...
 {"style": "background:  rgb(95, 37, 154); font-family: 'Arial';",
  ...
  "size": [400, 250],
  "size": [400, 250],
  "chumlabel": { "style": "background-image:url($path/chumlabelbg.png);background-color:rgb(128,70,187); background-repeat: no-repeat; color: white; padding: 2px; border:1px solid #c2c2c2; margin-bottom: 4px;",
 ...
 {"memoicon": "$path/memo.png",
  ...
  "label": { "text": "Bulletin Board: $channel",
             "style": "background-image:url($path/chumlabelbg.png);background-color:rgb(128,70,187); background-repeat: no-repeat; color: white; padding: 2px; border:1px solid #c2c2c2; margin-bottom: 4px;",
             "align": { "h": "left", "v": "center" },
             "minheight": 18,
             "maxheight": 36
           },
  ...
  "time": { "text": { "width": 75,
            ...
            "slider": { "style": " border:1px solid #c2c2c2;",
                        ...
                        "handle": "image:url($path/mirthful.png);"
                      },
            "buttons": { "style": "border:1px solid #a56adf; height: 17px; width: 50px; color: #bf84f9; font-family: 'Arial'; background: rgb(97, 39, 156); margin-left: 2px;" },
 ...
 "toasts":
 {
   "width": 210,
   "height": 100,
   "style": "background: rgb(128,70,187);",
   ...
   "content": { "style": "background: rgb(95, 37, 154); color: black; padding: 5px;" }
 }
}
